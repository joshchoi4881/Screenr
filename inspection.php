...
<html lang="en">
	...
	<body>
		...
		<div class="inspection">
			<h1>Capital Inspection</h1>
            <div class="chat">
                <div class="messages">
                    <div class="message">
                        <div class="fromThem">
                            <p>Do you have a platform that
                            allows users to rent their capital
                            for money? We can help you inspect
                            the capital rented on your platform
