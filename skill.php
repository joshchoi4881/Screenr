...
<html lang="en">
	...
	<body>
		...
		<div class="skill">
			<h1>Skill Interviews</h1>
            <div class="chat">
                <div class="messages">
                    <div class="message">
                        <div class="fromThem">
                            <p>Screenr can help you screen the workers
                            that apply to work on your gig economy platform!</p>
                        </div>
                        <div class="myMessage">
                            <p>How is this done?</p>
                        </div>
                        <div class="fromThem">
                            <p>You tell us the skills your gig economy
                            platform requires, and we'll match you with
                            the relevant professionals to personally
                            interview your applicants</p>
                        </div>
                        <div class="myMessage">
            ...
            <form action="skill.php" method="POST">
                ...
                <br/>
                <label>Skills</label>
                <input type="text" name="skills" value="" placeholder="Ex: Driving, Cleaning, Fitness Training" required/>
                <br/>
                <br/>
